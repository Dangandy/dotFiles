...
--
myWorkspaces = ["one","2:web","three","four","5:float"] ++ map show [6..9]
...
myManageHook = composeAll
    ...
    , resource =? "google-chrome-stable"    --> doFloat
    ]
...
--
defaultLayouts = ewmhDesktopsLayout $ avoidStruts 
    ( Tall 1 (3/100) (1/2) |||
...
-- myLayouts
myLayouts = onWorkspace "5:float" simplestFloat $ defaultLayouts
