...
### MY ALIAS ###################################################################
alias school='ssh -X dangandy@mathlab.utsc.utoronto.ca'
alias internet='wicd-curses'
alias c85='cd ~/School/CSCC85'
alias d27='cd ~/School/CSCD27'
alias c09='cd ~/School/CSCC09'
